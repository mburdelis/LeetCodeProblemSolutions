...
| [BestTimeToBuyAndSellStock.py](BestTimeToBuyAndSellStock.py) | Best Time to Buy and Sell Stock | Greedy |
| [ValidParentheses.py](ValidParentheses.py) | Valid Parentheses | Stack |
| [MergeIntervals.py](MergeIntervals.py) | Merge Intervals | Sorting / Arrays |
| [NumberOfIslands.py](NumberOfIslands.py) | Number of Islands | DFS / Graphs |
